...
const Home = () => {
  ...
  const {
    ...
    queryFn: ({ pageParam = offsetNumber }) =>
      getHomeFeed({ offset: pageParam, limit: 10, select: "-__v" }),
    getNextPageParam: () => {
          ...
          <Container maxW="full" paddingY="2" px="0" m="0" bg="none">
            ...
            >
              <HStack alignItems="flex-start" gap="5" my="5">
                <VStack width={isLargerThan900 ? "660px" : "full"}>
                  {renderMemoPost}
                ...
                {isLargerThan1250 && (
                  <VStack width="300px" gap="3" alignItems="flex-start">
                    <UserWidget />
                    <SuggestedUser />
                    <HomeWidget />
                  </VStack>
...
const HomeWidget = () => {
  ...
  return (
    <>
      ...
      <Text fontSize="x-small" color="secondaryText" textAlign="start">
    ...
    >
      <Flex gap="3" alignItems="center" justifyContent="flex-start">
        ...
        <VStack gap="0" alignItems="flex-start">
          ...
          <Text fontWeight="thin" color="secondary">
            {signedUser.fullName}
          </Text>
        </VStack>
      </Flex>
      <Button variant="unstyled" fontSize="sm" color="follow">
        Switch
      </Button>
    </HStack>
  );
